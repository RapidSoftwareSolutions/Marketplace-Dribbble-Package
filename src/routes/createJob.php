...
$app->post('/api/Dribbble/createJob', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','organizationName','title','location','url']);
    ...
    $query_str = $settings['api_url'] . "jobs";
